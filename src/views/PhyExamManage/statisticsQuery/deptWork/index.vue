<template>
  <div class="base-setting">
    <div style="width: 100%; height: 100%; overflow: auto">
      ...
      <div
        class="mt-4px"
        style="padding: 10px; background-color: #fff; height: calc(100vh - 190px)"
      >
        <el-table
          ref="adviceTableRef"
          :data="paginatedData"
...
const allColumns = [
  ...
  { prop: 'personalCount', label: '组合代码', align: 'center' },
  { prop: 'physicalExamId', label: '科室代码', align: 'center' },
  { prop: 'age', label: '单价', align: 'center' },
  ...
  { prop: 'physicalExamId', label: '单位代码', align: 'center' },
