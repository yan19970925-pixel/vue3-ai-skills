<template>
  <div class="base-setting">
    <div style="width: 100%; height: 100%; overflow: auto">
      <div class="base-box mb-8px pt-8px" style="background-color: #fff">
        <div class="base-cont">
      ...
      <div
        class="mt-4px"
        style="padding: 10px; background-color: #fff; height: calc(100vh - 162px)"
      >
        <el-table
          ref="adviceTableRef"
          :data="paginatedData"
          ...
          style="width: 100%; height: calc(100% - 46px); min-height: 300px; text-align: center"
...
const allColumns = [
  ...
  { prop: 'age', label: '体检次数', align: 'center' },
  { prop: 'age', label: '年龄', align: 'center' },
  { prop: 'physicalExamId', label: '电话号码', align: 'center' },
  { prop: 'personalCount', label: '诊断情况', align: 'center' },
  { prop: 'personalCount', label: '健康建议', align: 'center' }
