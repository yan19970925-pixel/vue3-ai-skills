<template>
  <div class="main">
      ...
      <div class="form">
        ...
        >
          <div class="form-item">
            ...
            <el-input v-model="searchKeyword" placeholder="请输入" style="width: 180px" />
            <span class="label-fixed-width">姓名:</span>
            <el-input v-model="searchKeyword" placeholder="请输入" style="width: 180px" />
            <span class="label-fixed-width">性别:</span>
            <el-input v-model="searchKeyword" placeholder="请输入" style="width: 180px" />
            <span class="label-fixed-width">体检单位:</span>
            <el-input v-model="searchKeyword" placeholder="请输入" style="width: 180px" />
          </div>
    ...
    <div
      ...
      style="padding: 10px; background-color: #fff; height: calc(100% - 61px)"
    >
      <!-- 一个tab栏三个tab -->

      <ElTabs v-model="currentActiveType" type="card" @tab-click="handleClick">
        <ElTabPane label="个人体检自然信息" name="Nature" style="margin-bottom: 0px">
          <Nature></Nature>
        </ElTabPane>
        <ElTabPane label="个人体检项目预定及完成情况" name="Scheduled" style="margin-bottom: 0px">
          <Scheduled></Scheduled>
        </ElTabPane>
        <ElTabPane label="本次体检结果" name="Outcome" style="margin-bottom: 0px">
          <Outcome></Outcome>
        </ElTabPane>
        <ElTabPane label="个人体检费用查询" name="CostQ" style="margin-bottom: 0px">
          <CostQ></CostQ>
        </ElTabPane>
      </ElTabs>
    </div>
...
import Scheduled from './components/Scheduled/index.vue'
import Nature from './components/Nature/index.vue'
import Outcome from './components/Outcome/index.vue'
import CostQ from './components/CostQ/index.vue'
