    ...
    <div class="mt-4px" style="padding: 10px; background-color: #fff; height: calc(100vh - 176px)">
      ...
      >
        ...
        <div style="color: #3473d1; margin-right: 20px; font-size: 16px; font-weight: 700">
          <span>
            预约单位：{{ filteredAddList.length }}个 预约总人数：{{ filteredAddList.length }}人
            未检人数：{{ filteredAddList.length }}人 （其中:单位体检：{{
              filteredAddList.length
            }}人;个人体检：{{ filteredAddList.length }}人）
          </span>
        </div>
        <el-pagination
          background
...
const addColumns = [
  ...
  { prop: 'inStoreQty', label: '单位次数', align: 'center' },
  { prop: 'unit', label: '体检号', align: 'center' },
  { prop: 'unitPrice', label: '姓名', align: 'center' },
  { prop: 'beginningAmount', label: '个人次数', align: 'center', width: '120px' },
  { prop: 'unit', label: '性别', align: 'center' },
  { prop: 'manufacturer', label: '体检状态', align: 'center' },
  { prop: 'beginningQty', label: '预约日期', align: 'center', width: '100px' }
