    ...
    <div style="width: 100%; height: 100%; overflow: auto">
      ...
      <div style="padding: 10px; background-color: #fff; height: calc(100vh - 142px)">
        ...
        >
          ...
          <!-- 就诊情况 -->
          <el-table-column prop="diagnosis" label="就诊情况" align="center"></el-table-column>

          <!-- 人数 -->
          <el-table-column label="人数" align="center">
            <el-table-column prop="total" label="总人数" align="center"></el-table-column>
            <el-table-column prop="maleCount" label="男人数" align="center"></el-table-column>
            <el-table-column prop="femaleCount" label="女人数" align="center"></el-table-column>
          </el-table-column>

          <!-- 人员名单 -->
          <el-table-column label="人员名单" align="center">
...
// 模拟人名列表
const namePool = ['张三', '李四', '王五', '赵六', '孙七', '周八', '吴九', '郑十']
...
function generateMockData() {
  ...
  for (let i = 0; i < 35; i++) {
    ...
    // 生成随机人名列表
    const personList = getRandomNames(Math.min(male + female, 5)) // 最多显示 5 个名字
