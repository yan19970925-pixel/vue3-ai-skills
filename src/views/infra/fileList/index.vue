<template>
  ...
  <content-wrap>
    <el-table v-loading="loading" :data="list" align="center">
      ...
      <el-table-column label="URL" align="center" width="80">
        <template #default="scope">
          <el-image :src="scope.row.url" fit="contain" class="imageUrl" />
        </template>
      </el-table-column>
      <el-table-column
        label="文件大小"
      ...
      />
      <el-table-column label="文件类型" align="center" prop="ftype" width="180px" />
      <el-table-column
        label="上传时间"
        align="center"
        prop="createTime"
