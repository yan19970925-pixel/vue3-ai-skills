<template>
  <ContentWrap>
    <el-row>
      ...
      <!-- 表单设计器 -->
      <el-col>
        <fc-designer ref="designer" height="780px" class="buildPage" />
      </el-col>
    </el-row>
  </ContentWrap>
  ...
  <Dialog :title="dialogTitle" v-model="dialogVisible" max-height="600">
    <div ref="editor" v-if="dialogVisible">
      <el-button style="float: right" @click="copy(formData)"> 复制 </el-button>
...
import { copyToClipboard } from '@/utils/copy-code'
