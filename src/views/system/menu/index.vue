<template>
  <div style="width: 100%; height: calc(100vh - 54px); overflow: hidden; padding-top: 34px">
    <!-- 搜索工作栏 -->
    <ContentWrap>
      <el-form
        class="-mb-15px"
    ...
    <!-- 列表 -->
    <ContentWrap style="height: calc(100% - 75px); overflow-y: auto">
      <el-table
        v-loading="loading"
        :data="list"
        row-key="id"
      ...
      >
        ...
        <el-table-column prop="path" label="路由地址" width="360" :show-overflow-tooltip="true" />
