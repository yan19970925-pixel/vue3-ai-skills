<template>
  <content-wrap style="padding-top: 34px">
    <!-- 搜索工作栏 -->
    <el-form
      class="-mb-15px"
      :model="queryParams"
  ...
  <content-wrap>
    <el-table v-loading="loading" :data="list" style="position: relative; top: -20px">
      ...
      <el-table-column label="操作类型" align="center" prop="logType" width="150">
      ...
      />
      <el-table-column label="登陆结果" align="center" prop="result" width="180">
        <template #default="scope">
