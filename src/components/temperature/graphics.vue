    ...
    <table class="temperatureChart">
      <caption>
        ...
        <p style="position: relative; text-align: left">
          ...
          <span style="display: inline-block; width: 35px; text-align: left">{{
            info.age + '' + info.ageunit
          }}</span>
          ...
          <span style="display: inline-block; width: 160px; text-align: left">{{
            info.inDiagName || '-'
          }}</span>
      ...
      <tbody>
          ...
          <td colspan="3" rowspan="50">
            <div style="color: blue" class="num_wrapper">
              ...
              <div class="tengtong">
                ...
                <div style="width: 48%; font-size: 10px; -webkit-transform: scale(0.8)">
        ...
        <tr>
          ...
          >
            {{
              index === 0 ? '出水量(ml)' : typesViewData['011'] && typesViewData['011'][index - 1]
            }}
          </td>
        </tr>
        <tr>
          <td
            ...
            :key="index + '|005'"
          >
            {{ index === 0 ? '大便(次)' : typesViewData['005'] && typesViewData['005'][index - 1] }}
          </td>
        </tr>
        ...
        <tr>
          <td
            ...
            :key="index + '|004'"
          >
            {{ index === 0 ? '小便(次)' : typesViewData['004'] && typesViewData['004'][index - 1] }}
          </td>
        </tr>
        <tr>
          <td
            ...
            :key="index + '|030'"
          >
            {{ index === 0 ? '身高(cm)' : typesViewData['030'] && typesViewData['030'][index - 1] }}
          </td>
        </tr>
        <tr>
          <td
            ...
            :key="index + '|009'"
          >
            {{ index === 0 ? '体重(kg)' : typesViewData['009'] && typesViewData['009'][index - 1] }}
          </td>
        </tr>
        <tr>
          <td
            ...
            :key="index + '|010'"
          >
            {{ index === 0 ? '过敏药物' : typesViewData['010'] && typesViewData['010'][index - 1] }}
          </td>
        </tr>
      </tbody>
    </table>
...
export default {
  ...
  mounted() {
    ...
    const marginTop =
      (Math.round(this.$refs.topTd[0].getBoundingClientRect().height) - 18) * 10 + 28
  ...
  methods: {
    ...
    init() {
      ...
      main.append('path').attr('class', 'line lineColor').attr('d', line1(datasetPulse))
...
.tooltip {
  ...
  border-radius: 2px;
  background: linear-gradient(#fefdff, #e5e5f1); /* 标准的语法（必须放在最后） */
}
</style>
<style lang="less">
.table_wrap {
